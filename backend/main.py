...
if __name__ == "__main__":
 ...
 # Security enhancement: Use environment variables for host and port configuration.
 # This prevents unintentionally exposing the application on all network interfaces by default.
 # Defaulting to '127.0.0.1' is a safer practice for local development.
 # For containerized deployment (e.g., Docker), set UVICORN_HOST="0.0.0.0".
